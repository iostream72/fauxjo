...
public final class SQLTestHelper {
    public static Connection createConnection() throws IOException, ClassNotFoundException, IllegalAccessException, InstantiationException, SQLException {
    ...
    public static void initSchema(ConnectionSupplierSchema schema, Connection conn) throws SQLException {
        SimpleConnectionSupplier connSupplier = new SimpleConnectionSupplier(conn);
        schema.setSchemaConnectionSupplier(connSupplier);
    }

    public static Connection initSchema(ConnectionSupplierSchema schema) throws IOException, InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
