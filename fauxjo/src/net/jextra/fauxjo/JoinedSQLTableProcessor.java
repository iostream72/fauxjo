...
public class JoinedSQLTableProcessor<T extends Fauxjo> extends AbstractSQLProcessor<T>
{
	...
	private Map<Class<? extends Fauxjo>,SQLTableProcessor<? extends Fauxjo>> _sqlTableProcessors =
		new HashMap<Class<? extends Fauxjo>, SQLTableProcessor<? extends Fauxjo>>();
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public JoinedSQLTableProcessor<T> addChildTable( Class<? extends Fauxjo> beanClass, Schema schema, String tableName,
		String tableAlias, String joinCriteria )
		throws SQLException
	{
